...
data class IPodColorPalette(
    ...
    val screenSecondary: Color, // sfondo elementi secondari SULLO SCHERMO (icone, track progress bar): sempre chiaro, indipendente dal colore della scocca
...
object IPodPalettes {
    ...
    // 🤍 iPod Classic bianco originale
    val ClassicWhite = IPodColorPalette(
        bodyPrimary = Color(0xFFF6F6F2),
        bodySecondary = Color(0xFFE6E6E0),
        bodyEdge = Color(0xFFC4C4BC),
        screenBackground = Color(0xFFBFCBAE),
        screenText = Color(0xFF1A1A1A),
        screenAccent = Color(0xFF3D5A99),
        screenSecondary = Color(0xFFA8B89C),
        screenSelectedBg = Color(0xFF3D5A99),
    ...
    // ⬜ Silver / Acciaio spazzolato
    val Silver = IPodColorPalette(
        bodyPrimary = Color(0xFFD8DADC),
        bodySecondary = Color(0xFFC2C5C8),
        bodyEdge = Color(0xFF9EA2A6),
        screenBackground = Color(0xFFCBD6C3),
        screenText = Color(0xFF1A1A1A),
        screenAccent = Color(0xFF2C5F8A),
        screenSecondary = Color(0xFFAFC0A7),
        screenSelectedBg = Color(0xFF2C5F8A),
        screenSelectedText = Color(0xFFFFFFFF),
